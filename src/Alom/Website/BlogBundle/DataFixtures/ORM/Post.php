...
use Alom\Website\BlogBundle\Entity\Post as BlogPost;
use Doctrine\Common\DataFixtures\FixtureInterface;

class Post implements FixtureInterface {

    public function load($manager)
    {
        $post_Symfony2_Services = new BlogPost();
        ...
        $post_HTTP_Caching = new BlogPost();
        ...
        $post_Symfony2_Cache = new BlogPost();
