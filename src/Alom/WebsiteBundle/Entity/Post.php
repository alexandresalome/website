 ...
 *
 * @ORM\Entity(repositoryClass="Alom\WebsiteBundle\Entity\PostRepository")
 */
class Post
{
    /**
     ...
     *
     * @var Alom\WebsiteBundle\Entity\Post
     */
    protected $nextPost;
     ...
     * Set the next post
     *
     * @param Alom\WebsiteBundle\Entity\Post $post The next post
     */
     ...
     *
     * @param Alom\WebsiteBundle\Entity\Post $post The previous post
     */
     ...
     * Get the next post
     *
     * @return Alom\WebsiteBundle\Entity\Post The next post, or false if
     ...
     *
     * @return Alom\WebsiteBundle\Entity\Post The previous post, or false
