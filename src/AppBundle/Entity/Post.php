...
class Post
{
     ...
     * Set the next post
     *
     * @param AppBundle\Entity\Post $post The next post
     */
     ...
     *
     * @param AppBundle\Entity\Post $post The previous post
     */
     ...
     * Get the next post
     *
     * @return AppBundle\Entity\Post The next post, or false if
     ...
     *
     * @return AppBundle\Entity\Post The previous post, or false
